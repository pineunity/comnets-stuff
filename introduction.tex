...
Toward 5G networks and the fourth industries, Telco companies and service providers are facing with tremedous oppotunities and challenges. One of them is to support innovative mobile applications, which require new generations of smart devices (e.g., AR/VR and smartphone) that are quickly released. Such a phenomenon results in an explosion of data. The fact is that 63\% of the world population currently acquires a mobile subscription, meanwhile, it was just 20\% in the previous decade. In addition, the emerging Internet of Things (IoT) and Machine-Type-Communications (MTC) are expected to introduce a huge number of connections, reaching 1 billion by 2020,  defining promising business opportunities for mobile operators, yet impacting significantly the development of their mobile networks.
