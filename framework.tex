...
\item \textit{\textit{EdgeX}}: Like other MEC frameworks, EdgeX offers an open-source software platform at the edge of the network, that interacts with various IoT objects such as sensors and actuators. For IoT applications
