...
\item \textit{\textit{StarlingX}}: The first release of StarlingX is launched in October 2018. From 2019, StarlingX releases align with OpenStack releases. StarkingX offers a virtualization platform that allows easy deployment, low touch manageability, rapid reponse to events, and fast recovery.
