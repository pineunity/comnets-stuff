...
\begin{turn}{90}
    ...
    \begin{tabular}{ | p{2cm} | l | p{5cm} | p{5cm} | p{2.5cm} | }
    \hline
    ...
    Ericsson, China Unicom, etc. & Focus on easy deployment, low touch manageability, rapid response to events, and fast recovery. & OpenStack \\ \hline

    Airship & OpenStack &  AT\&T, SKT,
    Intel, Mirantis, etc. & Provide for automated cloud provisioning and life cycle management in a completely declarative and predictable way. & OpenStack, K8s \\ \hline

    EdgeX & tba & tba & tba & tba \\ \hline

    OpenEdge & tba & tba & tba & tba \\ \hline
